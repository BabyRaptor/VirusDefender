...
// Dao Ngoc Canh
bool js_cocos2dx_ParticleSystem_setAngleEqualEmitAngle(JSContext *cx, uint32_t argc, jsval *vp);
bool js_cocos2dx_ParticleSystem_setParticleCollisionRect(JSContext *cx, uint32_t argc, jsval *vp);
bool js_cocos2dx_ParticleSystem_setAirResistant(JSContext *cx, uint32_t argc, jsval *vp);
bool js_cocos2dx_ParticleSystem_setLengthDependOnSpeed(JSContext *cx, uint32_t argc, jsval *vp);
// =============
...
bool js_cocos2dx_ParticleSystem_getAngleEqualEmitAngle(JSContext *cx, uint32_t argc, jsval *vp);
